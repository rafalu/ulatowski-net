...
const nextConfig: NextConfig = {
  async rewrites() {
    return [
      ...
      { source: '/images/rafal-ulatowski-headshot.png', destination: '/images/rafal-photo.png' },
      { source: '/images/rafal-ulatowski-square-photo.png', destination: '/images/rafal-square-photo.png' },
      ...
      { source: '/images/rafal-ulatowski-headshot.webp', destination: '/images/rafal-photo.webp' },
      { source: '/images/rafal-ulatowski-square-photo.webp', destination: '/images/rafal-square-photo.webp' },
    ];
  }
  ,
  async headers() {
